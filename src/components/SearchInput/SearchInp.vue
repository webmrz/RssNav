...
// 搜索框配置
const inputTip = import.meta.env.VITE_INPUT_TIP ?? "探索未知的世界...";
...
:deep(.suggestions) {
  ...
  animation: fade-suggestions-in 0.3s ease;
  max-height: 300px;
  overflow-y: auto;
  z-index: 2;
  transform: translateY(-60px);
  ...
  .suggestion-item {
    ...
    &:hover {
      background: var(--main-input-hover-color);
    }
