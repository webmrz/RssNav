          ...
          >
            ...
            >
              ...
              <span class="text">{{ item }}</span>
                ...
                <div class="search-engine-source">
            搜索建议来自 {{ getSearchEngineName }}
          </div>
          </div>
          <!-- 添加搜索引擎来源提示 -->
...
// 获取搜索引擎名称
const getSearchEngineName = computed(() => {
  switch (set.searchEngine) {
    case 'baidu':
      return '百度';
    case 'bing':
      return '必应';
...
.suggestions {
  ...
  .search-engine-source {
    ...
    opacity: 0.6;
    border-top: 1px solid var(--suggestions-border-color);
    text-align: right;
    position: absolute;
    bottom: 0;
    right: 0; 
